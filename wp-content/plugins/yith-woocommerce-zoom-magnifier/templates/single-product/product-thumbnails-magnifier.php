...
if ( $attachment_ids ) {
    ...
    <div class="thumbnails <?php echo $enable_slider ? 'slider' : 'noslider' ?>">
        ...
        <?php if ( $enable_slider ) : ?>
            <div id="slider-prev"><span class="dashicons dashicons-controls-skipback"></span></div>
            <div id="slider-next"><span class="dashicons dashicons-controls-skipforward"></span></div>
        <?php endif; ?>
    </div>
<?php
}
